...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(2, 4601767324918573992),
      name: 'Task',
      lastPropertyId: const IdUid(3, 5237476061721453526),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2062602715487555980),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8278972064644664615),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5237476061721453526),
            name: 'isCompleted',
            type: 1,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 4601767324918573992),
      lastIndexId: const IdUid(0, 0),
      lastRelationId: const IdUid(0, 0),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [2863727506301382715],
